...
const Login = ({showSignUpState}: loginProps)=>{
    ...
    const handleSubmitLoginFrom = (event: React.FormEvent<HTMLFormElement>)=>{
    ...
    return (
        ...
        <form className='form' onSubmit={handleSubmitLoginFrom}>
            <div className='form-control'>
                <label>Username:</label>
                <Input type='text' name="username" value={loginFormData.username} placeholder="Username" onChange={handleChangeLoginForm} ></Input>
            </div>
            <div className='form-control'>
                <label>Password</label>
                <Input type='password' name='password' value={loginFormData.password} onChange={handleChangeLoginForm}></Input>
            </div>
            <div className='login-form-buttons'>
                <Button type='submit' >login</Button>
                { showSignUp ||(<Button type='button' onClick={()=> setShowSignUp(true)}>sign up</Button>) }
            </div>
        ...
        (<form className='form' onSubmit={handleSubmitRegisterForm}>
            <div className='form-control'>
                ...
                <Input type='text' name='first_name' placeholder='First Name' value={registerFormData.first_name} onChange={handleChangeRegisterForm}></Input>
            </div>
            <div className='form-control'>
                <label>Last Name:</label>
                <Input type='text' name='last_name' placeholder='Last Name' value={registerFormData.last_name} onChange={handleChangeRegisterForm}></Input>
            </div>
            <div className='form-control'>
                <label>E-mail:</label>
                <Input type='text' name='email' placeholder='E-mail' value={registerFormData.email} onChange={handleChangeRegisterForm}></Input>    
            </div>
            <div className='form-control'>
                <label>Username:</label>
                <Input type='text' name="username" placeholder="Username" value={registerFormData.username} onChange={handleChangeRegisterForm}></Input>
            </div>
            <div className='form-control'>
                <label>Password:</label>
                <Input type='password' name='password' value={registerFormData.password} onChange={handleChangeRegisterForm}></Input>
            </div>
            <div className='form-control'>
                <label>Re-type Password:</label>
                <Input type='password' name='repassword' value={registerFormData.repassword} onChange={handleChangeRegisterForm}></Input>
            </div>
            {
